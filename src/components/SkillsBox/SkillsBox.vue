<template>
  <div
      class='SkillsBox grid grid-cols-3 gap-0.5 bg-primary-500 w-2/3 mx-auto rounded-lg justify-center items-center shadow-sm shadow-2xl p-2'>
    <div v-for='type in skillTypes'>
      <h3 class='text-2xl text-center min-w-min p-4'>{{ type.name }}</h3>
      <ul class=' bg-primary-100 border-2 border-primary-500 border-opacity-100 p-4 rounded-lg shadow-sm h-full'>
